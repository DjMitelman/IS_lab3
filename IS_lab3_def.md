...
author: |
	 Таубер Кирилл Олегович НПИбд-02-19\inst{1}
...
![Содержимое файла /etc/group](image/03.png){ #fig:002 width=70% height=70% }
...
![Минимальные права для совершения операций](05.png){ #fig:004 }
