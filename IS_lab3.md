...
author: "Таубер Кирилл Олегович НПИбд-01-19"
...
1.	В предыдущей работе в установленной операционной системе создали учетную запись пользователя guest и задали пароль для пользователя (используя учетную запись администратора) и зашел в эту учетную запись
...
![Добавление пользователей в группу](img/01.png){ #fig:001 width=70% height=70% }
...
![Информация о пользователях](img/02.png){ #fig:002 width=70% height=70% }
...
![Содержимое файла /etc/group и регистрация в группе](img/03.png){ #fig:003 width=70% height=70% }
...
![Изменение прав у директории](img/04.png){ #fig:004 width=70% height=70% }
...
![Заполнение таблицы](img/05.png){ #fig:005 width=70% height=70% height=70% }
...
и заполнил таблицу [-@tbl:min-rig]
